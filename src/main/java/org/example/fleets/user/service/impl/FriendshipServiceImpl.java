...
public class FriendshipServiceImpl implements FriendshipService {
    ...
    public boolean addFriend(Long userId, FriendAddDTO addDTO) {
        ...
        if (userId.equals(addDTO.getFriendId())) {
            throw new BusinessException(ErrorCode.VALIDATE_FAILED.getCode(), "不能添加自己为好友");
        }
        ...
        if (locked == null || !locked) {
            ...
            throw new BusinessException(ErrorCode.FAILED.getCode(), "操作过于频繁，请稍后再试");
        }
        ...
        try {
            ...
            if (friendUser == null) {
                throw new BusinessException(ErrorCode.USER_NOT_FOUND.getCode(), "对方用户不存在");
            }
            
            if (friendUser.getStatus() != 1) {
                throw new BusinessException(ErrorCode.USER_DISABLED.getCode(), "对方账号已被禁用");
            }
            
            // 检查是否已经是好友
            if (isFriend(userId, addDTO.getFriendId())) {
                throw new BusinessException(ErrorCode.VALIDATE_FAILED.getCode(), "已经是好友关系");
            }
            
            // 检查是否被对方拉黑
            Friendship blockCheck = getFriendship(addDTO.getFriendId(), userId);
            if (blockCheck != null && blockCheck.getStatus() == 3) {
                throw new BusinessException(ErrorCode.VALIDATE_FAILED.getCode(), "无法添加该用户");
            }
            ...
            if (result1 <= 0 || result2 <= 0) {
                throw new BusinessException(ErrorCode.FAILED.getCode(), "添加好友失败");
            }
            ...
            throw new BusinessException(ErrorCode.SYSTEM_ERROR.getCode(), "添加好友失败");
        } finally {
    ...
    public boolean deleteFriend(Long userId, Long friendId) {
        ...
        try {
            ...
            if (result1 <= 0 && result2 <= 0) {
                throw new BusinessException(ErrorCode.VALIDATE_FAILED.getCode(), "好友关系不存在");
            }
            ...
            throw new BusinessException(ErrorCode.SYSTEM_ERROR.getCode(), "删除好友失败");
        }
    }
    ...
    public boolean blockFriend(Long userId, Long friendId) {
        ...
        try {
            ...
            if (friendship.getStatus() == 3) {
                throw new BusinessException(ErrorCode.VALIDATE_FAILED.getCode(), "已经拉黑该好友");
            }
            ...
            if (result <= 0) {
                throw new BusinessException(ErrorCode.FAILED.getCode(), "拉黑好友失败");
            }
            ...
            throw new BusinessException(ErrorCode.SYSTEM_ERROR.getCode(), "拉黑好友失败");
        }
    }
    ...
    public boolean unblockFriend(Long userId, Long friendId) {
        ...
        try {
            ...
            if (friendship.getStatus() != 3) {
                throw new BusinessException(ErrorCode.VALIDATE_FAILED.getCode(), "该好友未被拉黑");
            }
            ...
            int result = friendshipMapper.updateById(friendship);
            if (result <= 0) {
                throw new BusinessException(ErrorCode.FAILED.getCode(), "取消拉黑失败");
            }
            ...
            throw new BusinessException(ErrorCode.SYSTEM_ERROR.getCode(), "取消拉黑失败");
        }
    }
    ...
    public boolean updateRemark(Long userId, Long friendId, String remark) {
        ...
        if (StringUtils.hasText(remark) && remark.length() > 50) {
            throw new BusinessException(ErrorCode.VALIDATE_FAILED.getCode(), "备注长度不能超过50");
        }
        ...
        try {
            ...
            int result = friendshipMapper.updateById(friendship);
            if (result <= 0) {
                throw new BusinessException(ErrorCode.FAILED.getCode(), "更新备注失败");
            }
            ...
            throw new BusinessException(ErrorCode.SYSTEM_ERROR.getCode(), "更新备注失败");
        }
    }
    ...
    public boolean updateGroup(Long userId, Long friendId, String groupName) {
        ...
        if (StringUtils.hasText(groupName) && groupName.length() > 20) {
            throw new BusinessException(ErrorCode.VALIDATE_FAILED.getCode(), "分组名称长度不能超过20");
        }
        ...
        try {
            ...
            int result = friendshipMapper.updateById(friendship);
            if (result <= 0) {
                throw new BusinessException(ErrorCode.FAILED.getCode(), "更新分组失败");
            }
            ...
            throw new BusinessException(ErrorCode.SYSTEM_ERROR.getCode(), "更新分组失败");
        }
    }
    ...
    public List<FriendVO> getFriendList(Long userId) {
        ...
        try {
            ...
            throw new BusinessException(ErrorCode.SYSTEM_ERROR.getCode(), "获取好友列表失败");
        }
    }
    ...
    public PageResult<FriendVO> searchFriend(Long userId, String keyword, Integer pageNum, Integer pageSize) {
        ...
        try {
            ...
            throw new BusinessException(ErrorCode.SYSTEM_ERROR.getCode(), "搜索好友失败");
        }
    }
    ...
    public boolean acceptFriendRequest(Long userId, Long friendId) {
        ...
        try {
            ...
            if (friendship1 == null || friendship2 == null) {
                throw new BusinessException(ErrorCode.VALIDATE_FAILED.getCode(), "好友请求不存在");
            }
            
            if (friendship1.getStatus() != 0 || friendship2.getStatus() != 0) {
                throw new BusinessException(ErrorCode.VALIDATE_FAILED.getCode(), "好友请求状态异常");
            }
            ...
            if (result1 <= 0 || result2 <= 0) {
                throw new BusinessException(ErrorCode.FAILED.getCode(), "接受好友请求失败");
            }
            ...
            throw new BusinessException(ErrorCode.SYSTEM_ERROR.getCode(), "接受好友请求失败");
        }
    }
    ...
    public boolean rejectFriendRequest(Long userId, Long friendId) {
        ...
        try {
            ...
            if (result1 <= 0 || result2 <= 0) {
                throw new BusinessException(ErrorCode.FAILED.getCode(), "拒绝好友请求失败");
            }
            ...
            throw new BusinessException(ErrorCode.SYSTEM_ERROR.getCode(), "拒绝好友请求失败");
        }
    }
    ...
    public List<FriendVO> getPendingFriendRequests(Long userId) {
        ...
        try {
            ...
            throw new BusinessException(ErrorCode.SYSTEM_ERROR.getCode(), "获取好友请求列表失败");
        }
    }
